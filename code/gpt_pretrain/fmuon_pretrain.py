...
optimizer2 = FMuon(hidden_matrix_params, lr=0.07, momentum=0.96, weight_decay=0.0, sgd_coeff=0.5) # F-Muon
optimizer2 = FMuon(hidden_matrix_params, lr=0.07, momentum=0.96, weight_decay=0.0, sgd_coeff=1) # NSGD
optimizer2 = FMuon(hidden_matrix_params, lr=0.05, momentum=0.95, weight_decay=0.0, sgd_coeff=0) # should be Muon
