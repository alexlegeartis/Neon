...
class SMuon(torch.optim.Optimizer):
    ...
    """
    def __init__(self, params, lr=0.02, weight_decay=0.01, momentum=0.95, sgd_coeff=0, sign_lr_mult=1):
            ...
            for base_i in range(0, len(params), world_size):
                ...
                if base_i + rank < len(params):
                    ...
                    if sgd_coeff != 1:
                        ...
                        update = (1 - sgd_coeff) * update_part + sgd_coeff * group["sign_lr_mult"] * grad.sign()
                    else:
                        update = group["sign_lr_mult"] * grad.sign()
...
# optimizer2 = SMuon(hidden_matrix_params, lr=0.01, momentum=0.95, weight_decay=0.01, sgd_coeff=1, sign_lr_mult=0.1) # purse SignSGD, eff lr = 1e-3; you may drop WD

optimizer2 = SMuon(hidden_matrix_params, lr=0.05, momentum=0.95, weight_decay=0.01, sgd_coeff=0.5, sign_lr_mult=0.1 / 5) # S-Muon
