...
optimizer2 = FMuon(hidden_matrix_params, lr=0.025, momentum=0.95, rank=rank, world_size=world_size, sgd_coeff=0.5) # F-Muon classics
...
optimizer2 = SMuon(hidden_matrix_params, lr=0.025, momentum=0.95, rank=rank, world_size=world_size, sgd_coeff=1, sign_lr_mult=1) # SignSGD, try sign_lr_mult = 0.5 or lower as well
