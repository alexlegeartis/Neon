\PassOptionsToPackage{norelsize}{algorithm2e}
...
% Redefine the header to center the text
\makeatletter
\renewcommand\ps@jmlrtps{%
  \let\@mkboth\@gobbletwo
  \def\@oddhead{\hfill\scriptsize \@jmlrproceedings\hfill}%
  \def\@evenhead{\hfill\scriptsize \@jmlrproceedings\hfill}%
...
\title[Ky Fan Norms, Duals, and Norm Combinations for Matrix Optimization]{The Ky Fan Norms and Beyond: Dual Norms and Combinations for Matrix Optimization}
 ...
 \floatconts
   ...
   {\includegraphics[width=\linewidth]{figs/nanogpt/Nanogpt_finetune_results.pdf}}
 \end{figure}
