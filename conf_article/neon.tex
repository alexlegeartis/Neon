...
\end{equation}
By \cref{corollary:lin_comb_alg}, this is an LMO-algorithm corresponding to the unit ball of the norm $\norm{\cdot}_{\mathrm{F-KF-k}}$, given by
...
\begin{figure}[h!]
    ...
    \begin{subfigure}[t]{0.8\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figs/simple_lls/loss_vs_iteration_long_run.pdf}
        \caption{The loss}
        \label{fig:lls_loss}
    \end{subfigure}
...
\begin{table}[ht]
	...
	\begin{tabular}{|c|c|c|c|}
	  \hline
	  Method & lr  & momentum   & val\_accuracy, \% \\
	  \hline
	  NSGD & ? & ? & ? \\
	  \hdashline
	  SignSGD & ? $\cdot$ ? & ? & ? \\
	  \hdashline
	  Muon & 0.24 & 0.63 & $94.02 \pm 0.10$ \\
	  \hdashline
	  F-Muon & 0.42 & 0.63 & $94.04 \pm 0.13$\\
	  \hdashline
