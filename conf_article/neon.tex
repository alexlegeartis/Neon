...
\section{\replaced[id = IK, comment={I think the old one was a bit misleading. Merged what previously had been 2 subsections into this one and improved the notation. Also removed the thing about trust region, it'll be referenced in a succeeding sections.}]{Update Step as Constrained Optimization}{Problem Statement}}

Training a neural network involves optimizing a function of weight matrices. This naturally leads us to consider the problem of minimizing a differentiable matrix function: 
