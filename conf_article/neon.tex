...
Let us set $\gamma_k = 1$. This transforms algorithm defined by \cref{eq:trust_update} into Algorithm 1 from \cite{kovalev2025understanding}. Therefore, we can view \cref{eq:trust_update} both as an lmo-based algorithm and as a trust-region algorithm.
