...
\usepackage{natbib}  % Add natbib for better citation handling
...
\bibliographystyle{plainnat}  % Change to plainnat style
\bibliography{muon}  % Make sure to include the bibliography
