...
To derive the update formula for arbitrary $k$, we use the expression for the norm dual to the Ky Fan $k$-norm (see, for instance \citet{bhatia2013matrix}, p. 96):
\[
